<template>
  <div class="flex flex-row xs:flex-col sm:flex-row flex-wrap justify-between text-center sm:h-86 bg-tw-black w-full max-w-1200 m-auto">
    <div class="flex xs:flex-col sm:flex-row xs:justify-center sm:justify-left ">
      <div class="flex items-center justify-center xs:text-16 sm:text-18 text-tw-white xs:mt-20 sm:mt-0 sm:mb-0" :data-aos="linkClass"       
    data-aos-delay="100" data-aos-easing="ease-in-sine" data-aos-duration="800" data-aos-offset="0"
     >
    ...
    <div class="xs:w-full sm:w-163 flex justify-center items-center cursor-pointer xs:py-20 sm:py-0" @click="toHome" :data-aos="linkClass"       
    data-aos-delay="300" data-aos-easing="ease-in-sine" data-aos-duration="800" data-aos-offset="0">
